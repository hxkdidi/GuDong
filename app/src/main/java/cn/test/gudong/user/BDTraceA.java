...
/**
 * Created by jiahaodong on 2017/5/17-17:09.
 * 935410469@qq.com
 * https://github.com/jhd147350
 */

public class BDTraceA extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.a_bd_trace);
    ...
    private void initRoadData() {
        ...
        markerOptions = new MarkerOptions().flat(true).anchor(0.5f, 0.5f).icon(BitmapDescriptorFactory
                .fromResource(R.drawable.icon_marka)).position(polylines.get(0)).rotate((float) getAngle(0));
